...
define('__UNIQUE_HASH__', 'b944ee7bb0115ee31dd5a6426777a6ee');
...
function UpdatePath(& $rsCurrentScriptContent, & $rsNewScriptContent) 
{
	...
	if(!($nMatchResult === false) && $nMatchResult > 0) 
	{
		$rsNewScriptContent = str_replace('\'b944ee7bb0115ee31dd5a6426777a6ee\'', $lssScriptPathMatch[1], $rsNewScriptContent); 
	}
}
